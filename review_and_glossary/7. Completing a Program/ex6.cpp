...
const char help = 'h'; // Help opens a small manual
const char help_up = 'H'; // Help(uppercase) opens a small manual
...
Token Token_stream::get() // Get characters from cin
{
	...
	case help: // Outputs program manual
	case help_up:
...
/*void Symbol_table::pre_defined() { // Defines variables before the start of the program
