...
double primary() // Processes semicolons, numbers and returns variables
{
	...
	case roman: // If Token is a roman numeral
		return t.value; // Return the int value of roman numeral
...
void calculate() // Performs calculations
{
	while(true) try {
		...
		cout << result << Roman_int(statement()) << endl; // Output the result
	}
